# Промпт-шаблоны — AI Media Production Pipeline V3.0
...
1. Борды (Style / Object / Character / Location / Prop / Pose / Shot)
2. Keyframe Prompt
...
Image 4 = approved Object/Prop Board for [OBJECT].
...
Timeline:
0.0–1.0s: Start from Image 5 and Shot Board panel 1. [действие]  Camera: [...]  Locked: [...]
1.0–2.0s: Transition toward Shot Board panel 2. [действие]  Camera: [...]  Locked: [...]
2.0–3.0s: Follow Shot Board panel 3 / Action Board panels [x-y]. [действие]  Camera: [...]  Locked: [...]
3.0–4.0s: Follow Shot Board panel 4. [действие]
4.0–5.0s: Reach the final planned state from panel 5. Hold the ending long enough for edit.

Style: [из Style Board]    Environment: [из Location Board]
Post-production: Final text, Cyrillic, logos, UI, legal, CTA, typography added after generation. Leave clean blank areas or placeholders.
